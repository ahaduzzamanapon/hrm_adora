                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <label for=""></label>
                            <a href="#" onclick="processAttendence()" class="btn btn-primary">Process</a>
                        </div>
                    </div>
                    <div class="row">
...
<script>
    function getDailyAttendence(type) {
        var member_id = get_checked_member_id();
        ...
        window.open("{{ route('attendences.daily_attendence_report') }}?from_date="+from_date+"&to_date="+to_date+"&type="+type+"&member_id="+member_id, '_blank');
    }
</script>
<script>
    function processAttendence() {
        var from_date = $('#from_date').val();
        if(from_date == '') {
            alert('Please Enter From Date');
            return false;
       ...
       $.ajax({
           ...
           dataType: 'json',
           success: function(response) {
            alert('Attendence Processed Successfully');
           }
       })
    }
</script>
